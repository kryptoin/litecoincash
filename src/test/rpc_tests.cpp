...
BOOST_AUTO_TEST_CASE(rpc_rawparams) {
  ...
  BOOST_CHECK_THROW(CallRPC("decoderawtransaction DEADBEEF"),
                    std::runtime_error);
  std::string rawtx =
      "0100000001a15d57094aa7a21a28cb20b59aab8fc7d1149a3bdbcddba9c622e4f5f6a99e"
      "ce010000006c493046022100f93bb0e7d8db7bd46e40132d1f8242026e045f03a0efe71b"
      "bb8e3f475e970d790221009337cd7f1f929f00cc6ff01f03729b069a7c21b59b1736ddfe"
      "e5db5946c5da8c0121033b9b137ee87d5a812d6f506efdd37f0affa7ffc310711c06c7f3"
      "e097c9447c52ffffffff0100e1f505000000001976a9140389035a9225b3839e2bbf32d8"
      "26a1e222031fd888ac00000000";
  ...
  BOOST_CHECK_THROW(
      CallRPC(std::string("decoderawtransaction ") + rawtx + " extra"),
      std::runtime_error);
  BOOST_CHECK_NO_THROW(
      r = CallRPC(std::string("decoderawtransaction ") + rawtx + " false"));
  BOOST_CHECK_THROW(r = CallRPC(std::string("decoderawtransaction ") + rawtx +
                                " false extra"),
                    std::runtime_error);
...
BOOST_AUTO_TEST_CASE(rpc_rawsign) {
  ...
  std::string prevout =
      "[{\"txid\":"
      "\"b4cc287e58f87cdae59417329f710f3ecd75a4ee1d2872b7248f50977c8493f3\","
      "\"vout\":1,\"scriptPubKey\":"
      "\"a914b10c9df5f7edf436c697f02f1efdba4cf399615187\","
      "\"redeemScript\":"
      "\"512103debedc17b3df2badbcdd86d5feb4562b86fe182e5998abd8bcd4f122c6155b1b"
      "21027e940bb73ab8732bfdf7f9216ecefca5b94d6df834e77e108f68e66f126044c052ae"
      "\"}]";
...
BOOST_AUTO_TEST_CASE(rpc_createraw_op_return) {
  ...
  BOOST_CHECK_NO_THROW(CallRPC(
      ...
      "[{\"txid\":"
      "\"a3b807410df0b60fcb9736768df5823938b2f838694939ba45f3c0a1bff150ed\","
      "\"vout\":0}] "
...
BOOST_AUTO_TEST_CASE(rpc_parse_monetary_values) {
  BOOST_CHECK_THROW(AmountFromValue(ValueFromString("-0.0000001")), UniValue);

  BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("0")), 0LL);

  BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("0.0000000")), 0LL);

  BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("0.0000001")), 1LL);

  BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("0.1762219")), 1762219LL);

  BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("0.5")), 5000000LL);

  BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("0.5000000")), 5000000LL);

  BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("0.8989898")), 8989898LL);

  BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("1.0000000")), 10000000LL);
  ...
  BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("1e-7")), COIN / 10000000);

  BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("0.1e-6")),
                    COIN / 10000000);

  BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("0.01e-5")),
                    COIN / 10000000);

  BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString(
                        "0."
                        "000000000000000000000000000000000000000000000000000000"
                        "000000000000000000001e+68")),
                    COIN / 10000000);
  ...
  BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("0.0000001000000")), 1LL);

  BOOST_CHECK_THROW(AmountFromValue(ValueFromString("19e-9")), UniValue);

  BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("0.19e-5")), 19);
...
BOOST_AUTO_TEST_CASE(json_parse_errors) {
  ...
  BOOST_CHECK_EQUAL(AmountFromValue(ParseNonRFCJSONValue(
                        "0.0000000000000000000000000000000000001e+30 ")),
                    1);
