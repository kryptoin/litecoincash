...
QString BitcoinUnits::description(int unit) {
  ...
  case mBTC:
    return QString("Milli-LCC (1 / 1" THIN_SP_UTF8 "000)");
  case uBTC:
    return QString("Micro-LCC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
  default:
    return QString("???");
  }
}
...
qint64 BitcoinUnits::factor(int unit) {
  switch (unit) {
  case BTC:
    return 100000000 / COIN_SCALE;

  case mBTC:
    return 100000 / COIN_SCALE;
  case uBTC:
    return 100 / COIN_SCALE;
  default:
    return 100000000 / COIN_SCALE;
  }
}
