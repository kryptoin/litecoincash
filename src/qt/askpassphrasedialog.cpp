...
void AskPassphraseDialog::accept() {
  ...
  case Encrypt: {
    ...
    QMessageBox::StandardButton retval = QMessageBox::question(
        ...
        tr("Warning: If you encrypt your wallet and lose your passphrase, you "
           "will <b>LOSE ALL OF YOUR LITECOINCASH</b>!") +
          ...
          QMessageBox::warning(
              ...
              "<qt>" +
                  tr("%1 will close now to finish the encryption process. "
                     ...
                     "protect "
                     "your litecoincash from being stolen by malware infecting "
                     "your computer.")
                      .arg(tr(PACKAGE_NAME)) +
                  "<br><br><b>" +
                  tr("IMPORTANT: Any previous backups you have made of your "
                     "wallet file "
                     "should be replaced with the newly generated, encrypted "
                     "wallet file. "
                     "For security reasons, previous backups of the "
                     "unencrypted wallet file "
                     "will become useless as soon as you start using the new, "
                     "encrypted wallet.") +
                  "</b></qt>");
          QApplication::quit();
        } else {
  ...
  case Unlock:
    if (!model->setWalletLocked(false, oldpass)) {
      ...
      fWalletUnlockWithoutTransactions = fHiveOnly;
