...
public:
  ...
  bool operator()(CBeeCreationTransactionInfo &left,
...
public:
  explicit HiveTableModel(const PlatformStyle *_platformStyle, CWallet *wallet,
                          WalletModel *parent);
  ~HiveTableModel();
  ...
  void getSummaryValues(int &_immature, int &_mature, int &_dead,
