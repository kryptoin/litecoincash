...
WalletModelTransaction::WalletModelTransaction(
    ...
    : recipients(_recipients), walletTransaction(0), fee(0) {
  walletTransaction = new CWalletTx();
}

WalletModelTransaction::~WalletModelTransaction() { delete walletTransaction; }
...
unsigned int WalletModelTransaction::getTransactionSize() {
  return (!walletTransaction
              ? 0
              : ::GetVirtualTransactionSize(*walletTransaction->tx));
}

CAmount WalletModelTransaction::getTransactionFee() const { return fee; }
