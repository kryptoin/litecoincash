...
static const unsigned int MAX_OPCODE = OP_NICK_CREATE;
...
public:
  ...
  static bool IsBCTScript(CScript scriptPubKey, CScript scriptPubKeyBCF,
                          CScript *scriptPubKeyHoney = nullptr) {
    ...
    CScript localScriptPubKeyHoney(&scriptPubKey[27],
                                   &scriptPubKey[scriptPubKey.size()]);
